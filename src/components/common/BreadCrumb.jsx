  ...
  return (
	...
	<ol className="flex h-8 space-x-2">
		<li className="flex items-center">
			<Link to="/" rel="noopener noreferrer" href="#" title="Back to homepage" className="hover:underline">
		...
		<li className="flex items-center space-x-2">
			...
			<a rel="noopener noreferrer" href="#" className="flex items-center px-1 capitalize hover:underline pointer-events-none disabled">{name}</a>
		</li>
	</ol>
</nav>
  )
