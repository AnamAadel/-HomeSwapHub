        ...
        <form onSubmit={handleSearch}>
          <div className="relative z-10 flex space-x-3 p-3 bg-white border rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-900/[.2]">
            ...
            <div className="flex-[0_0_auto]">
              <button type="submit" className="p-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-gray-700 text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-700 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800" >
